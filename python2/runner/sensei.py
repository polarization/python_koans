...
class Sensei(MockableTestResult):
    ...
    def errorReport(self):
        ...
        self.stream.writeln("  {0}{1}{2} has damaged your "
                            "karma.".format(Fore.RED, Style.BRIGHT,
    ...
    def scrapeInterestingStackDump(self, err):
        ...
        stack_text = re.sub(r'(about_\w+.py)',
                            r"{0}\1{1}".format(Fore.BLUE, Fore.YELLOW),
                            stack_text)
    ...
    def say_something_zenlike(self):
        if self.failures:
            ...
            return "{0}{1}{2}{3}".format(Fore.CYAN, zenness, Fore.RESET,
                                         Style.NORMAL)
        else:
    ...
    def filter_all_lessons(self):
        ...
        if not self.all_lessons:
            self.all_lessons = glob.glob(
                '{0}/../koans/about*.py'.format(cur_dir))
    ...
    def filter_all_optional_lessons(self):
        ...
        if not self.all_optional_lessons:
            ...
            self.all_optional_lessons = filter(
