...
class TestSensei(unittest.TestCase):
    ...
    def test_that_it_successes_only_count_if_passes_are_currently_allowed(
            self):
    ...
    def test_that_nothing_is_returned_as_a_first_result_if_there_are_no_failures(
            self):
        self.sensei.failures = []
        self.assertEqual(None, self.sensei.firstFailure())

    def test_that_nothing_is_returned_as_sorted_result_if_there_are_no_failures(
            self):
        self.sensei.failures = []
    ...
    def test_that_it_will_choose_correct_first_result_with_lines_9_and_27(
            self):
        self.sensei.failures = [
        ...
        self.assertEqual(
            "File 'about_trebuchets.py', line 9",
            self.sensei.firstFailure()[1])

    def test_that_it_will_choose_correct_first_result_with_multiline_test_classes(
            self):
        self.sensei.failures = [
        ...
        self.assertEqual(
            "File 'about_giant_feet.py', line 44",
            self.sensei.firstFailure()[1])
